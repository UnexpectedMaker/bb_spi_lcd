...
bool IRAM_ATTR my_vsync_callback(esp_lcd_panel_handle_t panel, const esp_lcd_rgb_panel_event_data_t *edata, void *user_ctx)
{
    vsync_flag = true;
    return false;
}
...
// Only safe to do this when VSYNC is ready
// Check the callback above
//
...
uint16_t *RGBInit(BB_RGB *pRGB)
{
    ...
    // panel_config.bounce_buffer_size_px = 40 * 480;
    ...
    // Before registration, define the callback struct
    esp_lcd_rgb_panel_event_callbacks_t cbs = {
        .on_vsync = my_vsync_callback};
